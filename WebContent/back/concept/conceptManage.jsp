...
<body>
	...
	<a href="<%= request.getContextPath() %>/back/concept/conceptAdd.jsp">新增概念</a>
		...
		<table  border="1">
			...
			<c:forEach var="group" items="${question_groups}" varStatus="loop">
				<tr>
					...
					<td><a href="<%= request.getContextPath() %>/back/QuestionBackServlet.do?action=conceptGroup&g_id=${group.g_id}">課程概念編輯</a></td>
				</tr>	
			</c:forEach>
	</table>
	</c:if>
