...
<% session.setAttribute("UserBackVO", null); %>
...
<body>
  ...
  <form action="<%= request.getContextPath() %>/UserServletBack.do"  class="gwd-form-14az" name="indexForm" >
  ...
  <p class="gwd-button-fujb"> 歡迎登入數位學習後台系統  </p>
