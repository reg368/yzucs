...
<body>
  ...
  <form action="<%= request.getContextPath()%>/front/question/question.jsp" method="post"  class="gwd-form-14az" name="indexForm" >
	<font class="gwd-input-gbnv">第  ${nowlevel} 關 :  ${nowlevelname}  </font>
    <button type="submit" class="gwd-button-r673">開始遊戲</button>
